...
<div class="container"><br>
	...
	<br><br>
	<form action="delete_student.php" method="post" enctype="multipart/form-data" class="" style="margin-left: 330px;">
	...
	<table class="table-bordered table-hover bg-light" style="margin-left: 270px;">
		<tr class="text-success font-weight-bold text-center"><th>No</th><th>Name</th><th>City</th><th>Parent's Contact No</th><th>Roll No</th><th>Standard</th><th>Image</th><th>Delete</th></tr>
		...
		<tr align="center">
			...
			<!-- <td><img src="../dataimg/<?php $data['image'];?>" style="max-width: 50px; max-height: 50px;"></td> -->
			<td><?php echo $data['image'];?><img src="<?php echo $data['image'];?>" width="100" height="100"></td>
			<td><a href="delete_form.php?kid=<?php echo $data['roll'];?>">delete</a></td>
		</tr>
		<?php
		}
		}
